  ...
  resources: {
    en: {
      translation: {
        ...
        invalidEnvKey: "Invalid key format",
        duplicateEnvKey: "Key already exists",
        emptyGroupHint: "No variables yet. Click Add to create one, or Batch edit to edit as text.",
        ok: "OK",
        cancel: "Cancel",
    ...
    "zh-CN": {
      translation: {
        ...
        invalidEnvKey: "Key 格式不正确",
        duplicateEnvKey: "Key 已存在",
        emptyGroupHint: "暂无变量，可点击「新增变量」逐条编辑，或使用「批量编辑」。",
        ok: "确定",
        cancel: "取消",
        unnamedGroup: "未命名",
    ...
    "zh-TW": {
      translation: {
        ...
        invalidEnvKey: "Key 格式不正確",
        duplicateEnvKey: "Key 已存在",
        emptyGroupHint: "尚無變數，可點擊「新增變數」逐條編輯，或使用「批次編輯」。",
        ok: "確定",
        cancel: "取消",
        unnamedGroup: "未命名",
